...
2. [Sending 1,000 CASH to new wallet addresses.](#option2)
...
### Send 1,000 CASH to New Addresses

Just like setting up a standard MN. Send exactly 1,000 CASH to each new address created above.
...
*Please note, the masternode priviate key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 1,000 CASH on the remote server and defeats the purpose of a hot/cold setup.*
