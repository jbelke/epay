...
##perform gitian builds
 ...
 Build epayd and epay-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit epay=v${VERSION} ../epay/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../epay/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r epay-${VERSION}-linux-gitian.zip *
	mv epay-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit epay=v${VERSION} ../epay/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../epay/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r epay-${VERSION}-win-gitian.zip *
	mv epay-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit epay=v${VERSION} ../epay/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
