    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ePay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ePay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and epay: URIs)"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About ePay Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About ePay Core"), this);
    aboutAction->setStatusTip(tr("Show information about ePay"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ePay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ePay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ePay addresses"));
    ...
    openAction->setStatusTip(tr("Open a epay: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the ePay Core help message to get a list with possible ePay command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("ePay client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("ePay client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ePay network", "", count));
}
...
{
    QString strTitle = tr("ePay"); // default title
